...
**Atende clientes:** sim — carteira mista de PF e PJ
**Equipe:** Paula + Thaís (formada em Direito, não advogada, auxilia em demandas de menor complexidade)
**Ferramentas:** Legal One (Thomson Reuters, sistema processual), WhatsApp Business, Microsoft 365 (Outlook e afins — já conectado via MCP), sistema próprio de registro de demandas consultivas em https://paula-blush-rho.vercel.app/
**Principais entregas:** pareceres e respostas consultivas, análise de contratos, peças processuais, conteúdo pra redes sociais (área nova, em estruturação)
